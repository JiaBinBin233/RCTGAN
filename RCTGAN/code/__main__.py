...
from ctgan1.data import read_csv
from ctgan1.synthesizers.ctgan import CTGANSynthesizer
...
def _parse_args():
    ...
    parser.add_argument('-t', '--tsv', action='store_true',
                        help='Load data_set in TSV format instead of CSV')
    ...
    parser.add_argument('-n', '--num-samples', type=int,
                        help='Number of rows to sample. Defaults to the training data_set size')
    ...
    parser.add_argument('data_set', help='Path to training data_set')
